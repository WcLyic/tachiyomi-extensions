...
class Dmzj : ConfigurableSource, HttpSource() {
    ...
    override fun pageListRequest(chapter: SChapter) = GET("https://api.m.dmzj1.com/comic" + chapter.url.replace(".json", ".html"), headers) // Backward compatibility
    ...
    override fun pageListParse(response: Response): List<Page> {
        ...
        val arr = try {
            ...
            obj.getJSONArray("page_url") // m.dmzj1.com already return HD image url
        }
